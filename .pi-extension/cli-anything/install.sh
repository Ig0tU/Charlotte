...
HARNESS_SRC="$REPO_ROOT/cli-anything-web-plugin/HARNESS.md"
...
TEMPLATES_SRC="$REPO_ROOT/cli-anything-web-plugin/templates"
...
# Copy scripts/repl_skin.py from the canonical location
REPL_SKIN_SRC="$REPO_ROOT/cli-anything-web-plugin/scripts/repl_skin.py"
...
SKILL_GEN_SRC="$REPO_ROOT/cli-anything-web-plugin/scripts/skill_generator.py"
...
TESTS_SRC="$REPO_ROOT/cli-anything-web-plugin/tests"
if [ -d "$TESTS_SRC" ]; then
