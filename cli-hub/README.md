...
Package manager for [CLI-Anything](https://github.com/ItamarZand88/CLI-Anything-WEB) — a framework that auto-generates stateful CLI interfaces for GUI applications, making them agent-native.
...
**Web Hub**: [itamarzand88.github.io/CLI-Anything-WEB](https://itamarzand88.github.io/CLI-Anything-WEB)
...
- **Web Hub**: [itamarzand88.github.io/CLI-Anything-WEB](https://itamarzand88.github.io/CLI-Anything-WEB)
- **Repository**: [github.com/ItamarZand88/CLI-Anything-WEB](https://github.com/ItamarZand88/CLI-Anything-WEB)
