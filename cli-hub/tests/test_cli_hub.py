...
SAMPLE_REGISTRY = {
    "meta": {"repo": "https://github.com/ItamarZand88/CLI-Anything-WEB", "description": "test"},
    "clis": [
        {
            "name": "gimp",
            "display_name": "GIMP",
            ...
            "install_cmd": "pip install git+https://github.com/ItamarZand88/CLI-Anything-WEB.git#subdirectory=gimp/agent-harness",
        ...
        },
        {
            ...
            "install_cmd": "pip install git+https://github.com/ItamarZand88/CLI-Anything-WEB.git#subdirectory=blender/agent-harness",
        ...
        },
        {
            ...
            "install_cmd": "pip install git+https://github.com/ItamarZand88/CLI-Anything-WEB.git#subdirectory=audacity/agent-harness",
...
class TestAnalytics:
    ...
    def test_track_event_sends_request(self, mock_send):
        with patch.dict(os.environ, {}, clear=True):
            ...
            assert payload["properties"]["hostname"] == "itamarzand88.github.io/CLI-Anything-WEB"
    ...
    def test_track_event_supports_umami_provider(self, mock_send):
        with patch.dict(os.environ, {"CLI_HUB_ANALYTICS_PROVIDER": "umami"}, clear=False):
            ...
            assert payload["payload"]["hostname"] == "itamarzand88.github.io/CLI-Anything-WEB"
    ...
    def test_track_install_event_name_is_flat(self, mock_send):
        ...
        with patch.dict(os.environ, {}, clear=True):
            ...
            assert payload["properties"]["$current_url"] == "https://itamarzand88.github.io/CLI-Anything-WEB/cli-anything-hub/install/gimp"
    ...
    def test_track_uninstall_event_name_is_flat(self, mock_send):
        ...
        with patch.dict(os.environ, {}, clear=True):
            ...
            assert payload["properties"]["$current_url"] == "https://itamarzand88.github.io/CLI-Anything-WEB/cli-anything-hub/uninstall/blender"
    ...
    def test_track_launch_fires(self, mock_send):
        ...
        with patch.dict(os.environ, {}, clear=True):
            ...
            assert payload["properties"]["cli"] == "gimp"
            assert payload["properties"]["$current_url"] == "https://itamarzand88.github.io/CLI-Anything-WEB/cli-anything-hub/launch/gimp"
    ...
    def test_track_visit_human(self, mock_send):
        ...
        with patch.dict(os.environ, {}, clear=True):
            ...
            assert payload["properties"]["$current_url"] == "https://itamarzand88.github.io/CLI-Anything-WEB/cli-anything-hub/call"
    ...
    def test_first_run_sends_event(self, mock_send, tmp_path):
        ...
        with patch.dict(os.environ, {"HOME": str(tmp_path)}, clear=False):
            ...
            assert payload["properties"]["$current_url"] == "https://itamarzand88.github.io/CLI-Anything-WEB/cli-anything-hub/installed"
